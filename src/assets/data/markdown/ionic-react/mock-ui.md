...
We'll want to display images for the tea data we will be mocking up, but these assets do not exist yet. <a href="/assets/packages/ionic-react/images.zip">Download the images</a> and unpack the zip file. Follow these steps to place them in the correct locations:
